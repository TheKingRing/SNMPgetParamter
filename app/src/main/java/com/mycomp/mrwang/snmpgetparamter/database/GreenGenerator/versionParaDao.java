...
/** 
 * DAO for table "VERSION_PARA".
*/
public class versionParaDao extends AbstractDao<versionPara, Long> {

    public static final String TABLENAME = "VERSION_PARA";

    /**
     * Properties of entity versionPara.<br/>
    ...
    */
    ...
    public versionParaDao(DaoConfig config) {
        super(config);
    }
    
    public versionParaDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"VERSION_PARA\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"VERSION_PARA\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, versionPara entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public versionPara readEntity(Cursor cursor, int offset) {
        versionPara entity = new versionPara( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, versionPara entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(versionPara entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(versionPara entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
