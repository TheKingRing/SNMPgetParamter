 ...
 */
public class SmoothcheckBoxforAdapter extends View implements Checkable {
    ...
    public SmoothcheckBoxforAdapter(Context context) {
        this(context, null);
    }

    public SmoothcheckBoxforAdapter(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SmoothcheckBoxforAdapter(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void setChecked(boolean checked) {
        ...
        invalidate();
        if (mListener != null) {
            mListener.onCheckedChanged(SmoothcheckBoxforAdapter.this, mChecked);
        }
    }
    ...
    private int measureSize(int measureSpec) {
        int defSize = helper.dp2px(getContext(), DEF_DRAW_SIZE);
    ...
    public interface OnCheckedChangeListener {
        void onCheckedChanged(SmoothcheckBoxforAdapter checkBox, boolean isChecked);
    }
}
