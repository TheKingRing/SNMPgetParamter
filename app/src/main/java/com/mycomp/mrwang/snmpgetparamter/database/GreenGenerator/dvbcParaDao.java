...
/** 
 * DAO for table "DVBC_PARA".
*/
public class dvbcParaDao extends AbstractDao<dvbcPara, Long> {

    public static final String TABLENAME = "DVBC_PARA";

    /**
     * Properties of entity dvbcPara.<br/>
    ...
    */
    ...
    public dvbcParaDao(DaoConfig config) {
        super(config);
    }
    
    public dvbcParaDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"DVBC_PARA\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"DVBC_PARA\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, dvbcPara entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public dvbcPara readEntity(Cursor cursor, int offset) {
        dvbcPara entity = new dvbcPara( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, dvbcPara entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(dvbcPara entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(dvbcPara entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
