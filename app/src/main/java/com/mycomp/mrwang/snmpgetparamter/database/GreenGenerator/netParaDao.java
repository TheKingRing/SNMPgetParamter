...
/** 
 * DAO for table "NET_PARA".
*/
public class netParaDao extends AbstractDao<netPara, Long> {

    public static final String TABLENAME = "NET_PARA";

    /**
     * Properties of entity netPara.<br/>
    ...
    */
    ...
    public netParaDao(DaoConfig config) {
        super(config);
    }
    
    public netParaDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"NET_PARA\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"NET_PARA\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, netPara entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public netPara readEntity(Cursor cursor, int offset) {
        netPara entity = new netPara( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, netPara entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(netPara entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(netPara entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
