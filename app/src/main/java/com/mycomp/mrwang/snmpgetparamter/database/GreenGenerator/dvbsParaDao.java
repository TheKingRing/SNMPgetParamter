...
/** 
 * DAO for table "DVBS_PARA".
*/
public class dvbsParaDao extends AbstractDao<dvbsPara, Long> {

    public static final String TABLENAME = "DVBS_PARA";

    /**
     * Properties of entity dvbsPara.<br/>
    ...
    */
    ...
    public dvbsParaDao(DaoConfig config) {
        super(config);
    }
    
    public dvbsParaDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"DVBS_PARA\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"DVBS_PARA\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, dvbsPara entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public dvbsPara readEntity(Cursor cursor, int offset) {
        dvbsPara entity = new dvbsPara( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, dvbsPara entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(dvbsPara entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(dvbsPara entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
