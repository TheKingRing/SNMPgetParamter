...
/**
 * Created by Mr Wang on 2016/6/19.
 */
public class SmoothCheck extends View implements Checkable {
    ...
    public SmoothCheck(Context context) {
        this(context, null);

    }

    public SmoothCheck(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SmoothCheck(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public SmoothCheck(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
