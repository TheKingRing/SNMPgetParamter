...
/** 
 * DAO for table "TRAP_PARA".
*/
public class trapParaDao extends AbstractDao<trapPara, Long> {

    public static final String TABLENAME = "TRAP_PARA";

    /**
     * Properties of entity trapPara.<br/>
    ...
    */
    ...
    public trapParaDao(DaoConfig config) {
        super(config);
    }
    
    public trapParaDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"TRAP_PARA\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"TRAP_PARA\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, trapPara entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public trapPara readEntity(Cursor cursor, int offset) {
        trapPara entity = new trapPara( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, trapPara entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(trapPara entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(trapPara entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
